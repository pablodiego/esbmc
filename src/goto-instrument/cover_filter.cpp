...
bool internal_functions_filtert::
operator()(const symbolt &function,
...
bool include_pattern_filtert::
operator()(const symbolt &function,
           const goto_functionst::goto_functiont &goto_function) const {
  (void)goto_function; // unused parameter
  std::smatch string_matcher;
  return std::regex_match(id2string(function.name), string_matcher,
                          regex_matcher);
}
...
bool trivial_functions_filtert::
operator()(const symbolt &function,
           const goto_functionst::goto_functiont &goto_function) const {
...
operator()(const locationt &source_location) const {
